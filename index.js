    ...
    if (interaction.isSelectMenu()) {
        if (interaction.customId === "painel_ticket") {
            ...
            if (opc === "opc1") {
                ...
                let nome = `🛠️・Suporte`;
                let categoria = "1061771538862444667"
                ...
                if (interaction.guild.channels.cache.find(c => c.name === nome)) {
                    ...
                    interaction.guild.channels.create({
                        ...
                        ch.send({ embeds: [embed], components: [botao] }).then(m => { m.pin() })
                    })
                }
                ...
                if (interaction.guild.channels.cache.find(c => c.name === nome)) {
                    ...
                    interaction.guild.channels.create({
                        ...
                        let embed = new Discord.EmbedBuilder()
                            .setColor("Random")
                            .setDescription(`Olá ${interaction.user}, Você abriu o ticket de Parceria, nos fale mais sobre sua proposta.`);
                        let botao = new Discord.ActionRowBuilder().addComponents(
                            new Discord.ButtonBuilder()
                                .setCustomId("fechar_ticket")
                                .setEmoji("🔒")
...
client.on('interactionCreate', async interaction => {
    ...
    if (interaction.customId === 'modal_sugestao') {
        ...
        let channel = client.channels.cache.get('1012975805162336276')
